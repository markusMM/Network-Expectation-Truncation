...
Some of the results, infering Garbor features from 200K 24x24 image patches out of the Van'Hateren nat. image database, can be seen in the plots directory.


To use this model, you can simply run the main script with the parameter file.

(mpirun / srun [-n 4]) python <main-script-name.py> <params-file-name.py>
